...
@testset "DataLoader MD Eigs" begin
    ...
    dl = DataLoader(Dict(""=>[2, 3, 4]), Dict(""=>[1]), Dict("" => 32), Dict("" => 32), conf)
    ...
    set_value!(conf, "val_data", "Optimizer", joinpath(path, "EIGENVAL_gaas"))
    dl = DataLoader(Dict(""=>[2, 3, 4]), Dict(""=>[1]), Dict("" => 32), Dict("" => 8), conf)
    ...
    dl = DataLoader(Dict(""=>[2, 3, 4]), Dict(""=>[1, 6, 8]), Dict("" => 32), Dict("" => 32), conf)
...
@testset "DataLoader PC Hr" begin
    ...
    # Test 1: test PC training data with no validation
    dl = DataLoader(Dict(""=>[]), Dict(""=>[]), Dict("" => 8), Dict("" => 8), conf)
...
@testset "DataLoader MD Hr" begin
    ...
    dl = DataLoader(Dict(""=>[1, 3]), Dict(""=>[]), Dict(""=>8), Dict(""=>8), conf)
