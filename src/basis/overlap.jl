...
get_overlap_label_id(v::ZeroOverlap, sameion::Bool) = 0
get_overlap_label_id(v::Vssσ, true) = 1
get_overlap_label_id(v::Vspσ, true) = 2
get_overlap_label_id(v::Vppσ, true) = 3
get_overlap_label_id(v::Vppπ, true) = 4
get_overlap_label_id(v::Vsdσ, true) = 5
get_overlap_label_id(v::Vpdσ, true) = 6
get_overlap_label_id(v::Vpdπ, true) = 7
get_overlap_label_id(v::Vddσ, true) = 8
get_overlap_label_id(v::Vddπ, true) = 9
get_overlap_label_id(v::Vddδ, true) = 10
get_overlap_label_id(v::Vssσ, false) = 11
get_overlap_label_id(v::Vspσ, false) = 12
get_overlap_label_id(v::Vppσ, false) = 13
get_overlap_label_id(v::Vppπ, false) = 14
get_overlap_label_id(v::Vsdσ, false) = 15
get_overlap_label_id(v::Vpdσ, false) = 16
get_overlap_label_id(v::Vpdπ, false) = 17
get_overlap_label_id(v::Vddσ, false) = 18
get_overlap_label_id(v::Vddπ, false) = 19
get_overlap_label_id(v::Vddδ, false) = 20

function get_overlap_string(i) 
    if i == 0; return "ZeroOverlap";
    elseif i == 1; return "NN0_Vssσ";
    elseif i == 2; return "NN0_Vspσ";
    elseif i == 3; return "NN0_Vppσ";
    elseif i == 4; return "NN0_Vppπ";
    elseif i == 5; return "NN0_Vsdσ";
    elseif i == 6; return "NN0_Vpdσ";
    elseif i == 7; return "NN0_Vpdπ";
    elseif i == 8; return "NN0_Vddσ";
    elseif i == 9; return "NN0_Vddπ";
    elseif i == 10; return "NN0_Vddδ";
    elseif i == 11; return "NN1_Vssσ";
    elseif i == 12; return "NN1_Vspσ";
    elseif i == 13; return "NN1_Vppσ";
    elseif i == 14; return "NN1_Vppπ";
    elseif i == 15; return "NN1_Vsdσ";
    elseif i == 16; return "NN1_Vpdσ";
    elseif i == 17; return "NN1_Vpdπ";
    elseif i == 18; return "NN1_Vddσ";
    elseif i == 19; return "NN1_Vddπ";
    elseif i == 20; return "NN1_Vddδ";
