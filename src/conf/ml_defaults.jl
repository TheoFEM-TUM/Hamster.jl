...
Sets the parameter for the similarity function of the kernel model.
"""
get_Z_sim_params(conf::Config)::Float64 = conf("Z_sim_params", "ML") == "default" ? get_sim_params(conf) : conf("Z_sim_params", "ML")
get_r_sim_params(conf::Config)::Float64 = conf("r_sim_params", "ML") == "default" ? get_sim_params(conf) : conf("r_sim_params", "ML")
get_phi_sim_params(conf::Config)::Float64 = conf("phi_sim_params", "ML") == "default" ? get_sim_params(conf) : conf("phi_sim_params", "ML")
get_theta_sim_params(conf::Config)::Float64 = conf("theta_sim_params", "ML") == "default" ? get_sim_params(conf) : conf("theta_sim_params", "ML")
get_env_sim_params(conf::Config)::Float64 = conf("env_sim_params", "ML") == "default" ? get_sim_params(conf) : conf("env_sim_params", "ML")
